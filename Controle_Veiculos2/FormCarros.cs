...
namespace Controle_Veiculos2
{
    public partial class FormCarros : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'sistemaBuggyDataSet.Carro' table. You can move, or remove it, as needed.
            this.carroTableAdapter.Fill(this.sistemaBuggyDataSet.Carro);
